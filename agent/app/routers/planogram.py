...
async def list_planograms() -> PlanogramListResult:
...
async def set_active_planogram(payload: ActivePlanogramBody) -> ActivePlanogramResult:
...
async def create_planogram(payload: PlanogramCreate) -> Planogram:
...
async def get_planogram(planogram_id: str) -> Planogram:
...
async def update_planogram(planogram_id: str, payload: PlanogramUpdate) -> Planogram:
    try:
...
async def delete_planogram(planogram_id: str) -> None:
    try:
